                ...
                <div className="new-req-section">
                    <div className="d-block heading">
                        ...
                        <div className="heading-buttons">
                            <Button variant="outlined" className="draft-btn"><SaveIcon />Save to Draft</Button>
                                    ...
                                    <div className="requester action">
                                        <div className="form-group">
                                            ...
                                            <div className="requisition-approval">
                                                ...
                                                <span className="text-danger pl-2">{errorData.saveReq.message}</span>
                                                ...
                                                <span className="text-danger pl-2">{errorData.sendApproval.message}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
