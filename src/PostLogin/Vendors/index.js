...
class Vendors extends Component {
    ...
    componentDidUpdate(prevProps, prevState) {
        if (prevProps.delete_vendor_status !== this.props.delete_vendor_status && this.props.delete_vendor_status == status.SUCCESS) {
            this.setState({
                openDialog: false,
                displayOption: false,
            })
        ...
        if (prevProps.get_vendor_status !== this.props.get_vendor_status && this.props.get_vendor_status === status.SUCCESS) {
            const { perPageLimit } = this.state
            if (this.props.getVendor && this.props.getVendor && this.props.getVendor.length > 0) {
    ...
    removeVendor = () => {
        this.props.dispatch(vendorAction.deleteVendor({ id: this.state.deleteIndex }));
            ...
            <div className="main-content">
                ...
                <Dialog open={openDialog} onClose={() => this.setState({ openDialog: false })} aria-labelledby="form-dialog-title" className="addNewItemDialog">
                    ...
                    <DialogActions className="dialogSmWidth addNewItemDialogActions">
                        <Button variant="contained" onClick={this.removeVendor} className="primary-btn">
                            Yes
                        </Button>
