              ...
              return (
                <td>
                  <button
                    ...
                    onClick={this.onClickShowViewDetails}
                  >
                    {value}
                  </button>
                </td>
        ...
        {selectBuyer === true ? (
          <div className="recieved-select-buyers-content">
            ...
            <div className="membar-list">
              <div className="row">{this.displayRecievedMemberList()}</div>
            </div>
          </div>
        ) : (
          <div className="recieved">
            {ViewDetail === true ? (
                ...
                <div className="recieved-bottom">
                  ...
                  <div className="recieved-button">
                    <Button
                      ...
                      onClick={this.onClickShowSelectBuyer}
                    >
                      Select Buyers
                    </Button>
                  </div>
                      ...
                      <div className="member-contact">
                        <ul>
                          ...
                          <li>
                            ...
                            <a href="mailto:petermorriss@gmail.com">
                              petermorriss@gmail.com
                            </a>
                          </li>
                        </ul>
                      </div>
              ...
              <>
                ...
                <Table
                  valueFromData={this.state.tableData}
                  perPageLimit={6}
